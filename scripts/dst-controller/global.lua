...
---@field modname string|nil Mod name from modmain
---@field MODROOT string|nil Mod root from modmain
---
...
---@field Dest fun(overridedest: any, pt: any, bufferedaction: any): any
...
---@field AddAction fun(action: string, str: string, fn: function)
